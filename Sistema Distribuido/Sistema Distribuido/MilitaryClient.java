...
public class MilitaryClient {
    ...
    private static volatile String userrank;

    public static void main(String[] args) throws IOException {
        if (args.length != 2) {
            System.err.println("Usage: java MilitaryClient <host name> <port number>");
            System.exit(1);
        }
    ...
    private static void startMulticastChat(String groupAddress, int port) {
        MulticastChat multicastChat = new MulticastChat(username, userrank);
